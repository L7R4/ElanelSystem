...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nro_contrato', models.CharField(default='', max_length=10, verbose_name='Nro Contrato:')),
                ...
                ('nro_orden', models.CharField(default='', max_length=10, verbose_name='Nro de Orden:')),
                ...
                ('adjudicado', models.JSONField(default={'autorizado_por': '', 'status': False, 'tipo': ''})),
