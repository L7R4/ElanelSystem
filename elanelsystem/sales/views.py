...
class Resumen(generic.View):
    ...
    def get(self,request,*args,**kwargs):
        ...
        feedback_ganancias = str ( round((((current_ganancias - last_ganancias) / last_ganancias) * 100), 2) )
        ...
        feedback_gastos = str ( round((((current_gastos - last_gastos) / last_gastos) * 100), 2) )
        ...
        # Medios de pago -> medios de pago (pie chart)
        medios = {
            'Postnet': 123,
            'MercadoPago': 50,
            'Transferencia': 40,
