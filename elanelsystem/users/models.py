...
class Usuario(AbstractBaseUser, PermissionsMixin):
    ...
    alias = models.CharField("Alias bancario", max_length=50, default="", blank=True, null=True)
    cbu = models.CharField("CBU", max_length=22, default="", blank=True, null=True)
    entidad_bancaria = models.CharField("Entidad Bancaria", max_length=100, default="", blank=True, null=True)
