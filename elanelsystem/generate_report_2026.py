...
excel_path = "../liquidaciones_2026_ene_may.xlsx"

# To collect agency-month totals
summary_data = {camp: {suc.pseudonimo: 0 for suc in sucursales} for camp in campaigns_2026}

print("Iniciando generación de liquidaciones de 2026 (Enero - Mayo)...")
...
for name in wb.sheetnames:
    ...
    if name == "Resumen General":
        ...
        # Total Row
        ws.cell(row=max_row + 1, column=1, value="TOTAL GENERAL 2026 (Ene-May)").font = font_total
...
wb.save(excel_path)
print(f"Reporte de liquidaciones 2026 (Ene-May) generado y formateado con éxito en: {os.path.abspath(excel_path)}")
